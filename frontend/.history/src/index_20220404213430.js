...
function App() {
  ...
  function rickroll(){
    document.getElementById('vlak').style.backgroundImage = "url(/rickroll.gif)";
  }
  return (
    <div className="demo">
      <div className='vlak' id='vlak' style={{backgroundImage: 'url(./rickroll.gif)'}}>
      <Progress
        className="budik1"
        progress={rpm}
        max={500}
      ...
      className="budik3"
        ...
        <label class="button a" onClick={rickroll} htmlFor='svetla'>Světla</label>
