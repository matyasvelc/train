  ...
  return (
    <div className="demo">
      ...
      className="budik3"
        ...
        <label class="buttona" htmlFor='svetla'>Světla</label>
        <button class="buttonb">Katapult</button>
        <button class="buttonc">Klakson</button>
        <button class="buttond">Z. Brzda</button>
