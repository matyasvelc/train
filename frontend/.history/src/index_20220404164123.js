  ...
  return (
    <div className="demo">
      ...
      <Progress
        ...
        <label class="button, 1" htmlFor='svetla'>Světla</label>
        <button class="button, 2" >Katapult</button>
        <button class="button, 3" >Klakson</button>
        <button class="button, 4" >Z. Brzda</button>
