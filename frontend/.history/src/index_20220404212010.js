  ...
  return (
    <div className="demo">
      ...
      className="budik3"
        ...
        <label class="button a" id='button' htmlFor='svetla'>Světla</label>
        <button class="button b" id='button'>Katapult</button>
        <button class="button c" id='button'>Klakson</button>
        <button class="button d" id='button'>Z. Brzda</button>
